document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('translateToEn').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Download Davinci Resolve Studio 18.5.1';
        ...
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Download Davinci Resolve Studio 18.5.1';
    ...
    document.getElementById('translateToRu').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Скачайте Davinci Resolve Studio 18.5.1';
        ...
        document.getElementById('expiryMessage').textContent = '';
        document.getElementById('timer').textContent = '';
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Скачать Davinci Resolve Studio 18.5.1';
