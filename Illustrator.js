document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('translateToEn').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Download Adobe Illustrator 2023';
        ...
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Download Adobe Illustrator 2023';
    ...
    document.getElementById('translateToRu').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Скачайте Adobe Illustrator 2023';
        ...
        document.getElementById('expiryMessage').textContent = '';
        document.getElementById('timer').textContent = '';
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Скачать Adobe Illustrator 2023';
