document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('translateToEn').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Download After Effects 2024';
        ...
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Download After Effects 2024';
    ...
    document.getElementById('translateToRu').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Скачайте After Effects 2024';
        ...
        document.getElementById('expiryMessage').textContent = '';
        document.getElementById('timer').textContent = '';
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Скачать After Effects 2024';
