document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('translateToEn').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Download Adobe Audition 2024';
        ...
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Download Adobe Audition 2024';
    ...
    document.getElementById('translateToRu').addEventListener('click', function() {
        document.querySelector('h1').textContent = 'Скачайте Adobe Audition 2024';
        ...
        document.getElementById('expiryMessage').textContent = '';
        document.getElementById('timer').textContent = '';
        document.getElementById('downloadLink').innerHTML = '<i class="fas fa-download"></i> Скачать Adobe Audition 2024';
